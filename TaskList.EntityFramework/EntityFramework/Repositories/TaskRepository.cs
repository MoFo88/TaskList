...
{
    public class TaskRepository : TaskListRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<TaskListDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
